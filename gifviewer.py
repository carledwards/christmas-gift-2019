...
def show_gif_frames(image_map, cache_dir, image_name, one_shot):
    global _oled, _stop
...
def run(oled, image_name, one_shot=False):
    global _oled, _stop
    _stop = False
    ...
    try:
        ...
        if stat.S_ISDIR(mode):
            try:
                ...
                show_gif_frames(_image_map, cache_dir, image_name, one_shot)
                return _stop
            except:
